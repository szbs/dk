...
<body>
							...
							<fieldset>
								...
								<div class="control-group">
									...
									<div class="controls">
										...
										<?php if(!empty($site_admin_url_password)): ?><span class="help-block">后台地址：<span id="js-site-admin-url"><?php echo sp_get_host();?>/web/daikaun?g=admin&upw=<?php echo C('SP_SITE_ADMIN_URL_PASSWORD');?></span></span><?php endif; ?>
									</div>
								</div>
								<div class="control-group">
	...
	<script type="text/javascript" src="/web/daikaun/public/js/common.js"></script>
	<script>
		/////---------------------
		$(function(){
