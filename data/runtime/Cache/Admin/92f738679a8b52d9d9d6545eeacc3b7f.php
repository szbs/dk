...
<meta charset="utf-8">
<title>钱山金服<?php echo L('ADMIN_CENTER');?></title>
...
<link href="/web/daikaun/public/simpleboot/font-awesome/4.4.0/css/font-awesome.min.css?page=index"  rel="stylesheet" type="text/css">
<!--[if IE 7]>
	<link rel="stylesheet" href="/web/daikaun/public/simpleboot/font-awesome/4.4.0/css/font-awesome-ie7.min.css">
<![endif]-->
<link rel="stylesheet" href="/web/daikaun/public/simpleboot/themes/<?php echo C('SP_ADMIN_STYLE');?>/simplebootadminindex.min.css?">
<link href="/web/daikaun/public/js/artDialog/skins/default.css" rel="stylesheet" />
<!--[if lte IE 8]>
	<link rel="stylesheet" href="/web/daikaun/public/simpleboot/css/simplebootadminindex-ie.css?" />
<![endif]-->
<style>
...
<body style="min-width:900px;" screen_capture_injected="true">
		...
		<div class="navbar-inner">
			<div class="container-fluid">
				<a href="<?php echo U('admin/index/index');?>" class="brand"> <small> 
					钱山金服<?php echo L('ADMIN_CENTER');?>
				</small>
				</a>
				<div class="pull-left nav_shortcuts" >
					
					<a class="btn btn-small btn-warning" href="/web/daikaun/" title="<?php echo L('WEBSITE_HOME_PAGE');?>" target="_blank">
				...
				<ul class="nav simplewind-nav pull-right">
					<li class="light-blue">
						<a data-toggle="dropdown" href="#" class="dropdown-toggle">
							...
							<?php else: ?>
								<img class="nav-user-photo" width="30" height="30" src="/web/daikaun/admin/themes/simplebootx/Public/assets/images/logo-18.png" alt="<?php echo ($admin["user_login"]); ?>"><?php endif; ?>
	...
	<script src="/web/daikaun/admin/themes/simplebootx/Public/assets/js/index.js"></script>
</body>
</html>