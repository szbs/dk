...
<body>
	<div class="wrap">
		<ul class="nav nav-tabs">
			<li><a href="<?php echo U('Qianshan/User/managelist');?>">信贷经理列表</a></li>
			<li class="active"><a href="<?php echo U('Qianshan/User/manageedit');?>">增加信贷经理</a></li>
		</ul>
		<form method="post" class="form-horizontal" action="<?php echo U('Qianshan/User/manageedit',array('id'=>$id));?>">
			<fieldset>
				<div class="control-group">
					<label class="control-label">姓名</label>
					<div class="controls">
						<input style="width:200px;" type="text" name="relname" id="relname" value="<?php echo ($relname_info['name']); ?>"/>
					</div>
				</div>
				<div class="control-group">
					<label class="control-label">手机</label>
					<div class="controls">
						<input style="width:200px;" type="text" name="mobile" id="mobile" value="<?php echo ($userinfo['mobile']); ?>"/>
					</div>
				</div>
				<div class="control-group">
					<label class="control-label">密码</label>
					<div class="controls">
						<input style="width:200px;" type="text" name="password" id="password" value=""/>
					</div>
				</div>
