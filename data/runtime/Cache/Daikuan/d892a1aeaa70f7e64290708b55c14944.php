...
<body>
	<div class="wrap js-check-wrap">
		<ul class="nav nav-tabs">
			<li class="active"><a href="<?php echo U('Daikuan/Admin/Product');?>">产品列表</a></li>
			<li><a href="<?php echo U('Daikuan/Admin/Productedit');?>">增加产品</a></li>
			<li><a href="<?php echo U('Daikuan/Admin/Productattribute');?>">产品属性</a></li>
